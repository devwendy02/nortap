...
function ml(e, t, n, r, l) {
    ...
    if (i) return i = e, l = l(i), e = r === "" ? "." + wo(i, 0) : r, es(l) ? (n = "", e != null && (n = e.replace(ts, "$&/") + "/"), ml(l, t, n, "", function(u) {
        return u
    })) : l != null && (qi(l) && (l = af(l, n + (!l.key || i && i.key === l.key ? "" : ("" + l.key).replace(ts, "$&/") + "/") + e)), t.push(l)), 1;
    if (i = 0, r = r === "" ? "." : r + ":", es(e))
            ...
            n.microTask(() => {
                ...
                n.addEventListener(t, "click", i => {
                    if (i.target instanceof HTMLElement) try {
                        ...
                        let {
                            hash: s
                        } = new URL(a.href), u = t.querySelector(s);
                        u && !l(u) && (o = u)
                    } catch {}
